...
/**
 * 
 * UPAReporter class contains UPA report implementation
 *
 */
public class UPAReporter {
	...
	// "/home/vagrant/testNow/TestNow/testnowjavaexample/src/test/java/com/java/cukes/reporting/report_template.html";
	private static final String templatePath = System.getProperty("user.dir")
			+ "/src/test/java/com/java/cukes/reporting/report_template.html";
	...
	public static void writeResults() {
		try {
			String reportPath = System.getProperty("user.dir")
					+ "/target/reports/har/upaReport.html";
			// String reportPath =
			// "/home/vagrant/testNow/TestNow/testnowjavaexample/src/test/reports/har/upaReport.html";
			...
			for (UPAResult upaResult : upaDetails) {
				...
				textToReplace += upaResult.getScenarioName()
						+ "</td><td width=\"60%\">";
				...
				reportIn = reportIn.replaceFirst(placeHolder, textToReplace
						+ placeHolder);

				Files.write(Paths.get(reportPath), reportIn.getBytes(),
